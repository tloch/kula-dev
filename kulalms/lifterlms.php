<?php
/**
* Plugin Name: KulaLMS Dev (for Mk.IV Theme)
* Plugin URI: http://kula.local
* Description: KulaLMS (based on LifterLMS)
* Version: 0.1
* Author: Kula WS 2016/17
* Author URI: http://kula.local
* License:     Kula
* License URI: http://kula.local
